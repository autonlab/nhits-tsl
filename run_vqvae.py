...
from exp.exp_long_term_forecasting_vqvae import Exp_Long_Term_Forecast
...
if __name__ == '__main__':
    ...
    parser.add_argument("--num_embeddings", type=int, default=128, help="Number of embeddings")
    ...
    if args.is_training:
        for ii in range(args.itr):
            ...
            setting = '{}_{}_{}_{}_ft{}_sl{}_ll{}_pl{}_dm{}_nh{}_el{}_dl{}_df{}_nh{}_pd{}_ne{}_des{}_{}'.format(
                args.task_name,
                args.model_id,
                args.model,
                args.data,
